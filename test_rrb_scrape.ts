...
async function run() {
  ...
  // Use official government sources instead
  console.log("SarkariResult scraping disabled. Use official government sources like uppbpb.gov.in, upsc.gov.in, ssc.nic.in");
  return;
