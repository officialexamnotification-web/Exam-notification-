                          ...
                          finalContent += `
                            <div class="my-8 rounded-lg overflow-hidden border border-blue-900/20 bg-blue-50/30 shadow-sm text-center">
                                ...
                                <div class="p-5 flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <a href="#" target="_blank" class="flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] hover:bg-[#20b857] text-white font-bold rounded-full transition-transform hover:-translate-y-1 shadow-md w-full sm:w-auto">
